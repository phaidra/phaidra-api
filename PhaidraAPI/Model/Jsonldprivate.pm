...
sub save_to_object(){
  ...
  return $object_model->add_or_modify_datastream($c, $pid, "JSON-LD-PRIVATE", "application/json", undef, $c->app->config->{phaidra}->{defaultlabel}, $json, "M", undef, undef, $username, $password);
}
